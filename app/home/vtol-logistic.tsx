    ...
    return (
        <section className="bg-[#EEEEEE]">
            <div className="blade-top-padding-lg  w-container ">
                ...
                <div className="  w-full h-[23rem] md:h-[22rem] xl:h-[27rem] 2xl:h-[32rem]  relative " > 
                    ...
                    <Image src="/assets/home/logistic/backgroundImageMobile.png" alt="VTOL-logistics and UAM-Eagleray" quality={90} fill className='   object-cover md:hidden' />
                    </div>
